...
# mindless husks of machinery -- until you first boot them up.
#
...
class Robot
  ...
  attr_accessor :name :reset

  def initialize
    @name = (0...2).map { (65 + rand(26)).chr }.join + 4.times.map{rand(10)}.join
  end
...
# the wear and tear on the robot mechanisms doesn't go away.
#
